...
(function() {
  define(['proxy-manager', 'text!../testdata/packages.json', 'text!../testdata/servers.json'], function(ProxyManager, testPackages, testServers) {
    testServers = JSON.parse(testServers);
    testPackages = JSON.parse(testPackages);
    return describe('Proxy Manager', function() {
      return describe('Script generation', function() {
