...
(function() {
  define(['package-manager', 'storage', 'config', 'text!../testdata/packages.json', 'text!../testdata/servers.json', 'runtime'], function(PackageManager, Storage, Config, testPackages, testServers, Runtime) {
    ...
    return describe('Package Manager', function() {
      beforeEach(function() {
        ...
        return this.runtimeStub = this.sandbox.stub(Runtime, 'restart');
      });
      afterEach(function() {
      ...
      describe('Installation behaviour', function() {
        return it('should download package information from server', function() {
          ...
          return assert.isTrue(this.runtimeStub.calledOnce);
        });
      });
